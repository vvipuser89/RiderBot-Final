...
# Gmongodb+srv://riderbhai: <riderbhai321>@cluster0 .yvrweeu.mongodb.net/?appName=Cluster
MONGO_URL = "mongodb+srv://riderbhai:riderbhai321@cluster0.yvrweuu.mongodb.net/?retryWrites=true&w=majority"
ADMIN_ID = 6075779781 
...
def run_attack(ip, port, duration, chat_id, message_id, username):
    ...
    # File name start.py ya main.py ho sakti hai repo ke hisaab se
...
def redeem(m):
    user_id = m.from_user.id
    key_text = m.text.split()[1] if len(m.text.split()) > 1 else ""
